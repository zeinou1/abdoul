            ...
            <div className="container mt-2">
                    ...
                    <div className="over__info lg:flex lg:flex-row flex flex-col  gap-10 ">
                        <div className="lg:w-[30%] flex flex-col items-center justify-center gap-1 relative">
                            <div className="relative p-1 ">
                                ...
                                <div
                                    className="absolute inset-0 border-4 ring-2 ring-primaryColor border-primaryColor rounded-full animate-pulse"></div>
                            </div>
              ...
              "
                  ...
                  <i className="ri-arrow-right-up-fill text-3xl text-center text-primaryColor"></i>
                            ...
                            <span
                                className="lg:hidden my-8 w-6 h-6 bg-gray-900 rounded-full flex items-center justify-center p-8 animate-bounce">
                <i className="ri-arrow-down-fill text-6xl text-center text-primaryColor"></i>
              </span>

                            <div
                                className="border-4 border-primaryColor px-4 py-2 bg-gray-800 shadow-xl transform transition-transform duration-300 hover:scale-105">
